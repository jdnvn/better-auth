...
- [#9393](https://github.com/better-auth/better-auth/pull/9393) [`62c4050`](https://github.com/better-auth/better-auth/commit/62c40508501f5056dacc9c9da94e4ddf9ada1001) Thanks [@IcanDivideBy0](https://github.com/IcanDivideBy0)! - `api.verifyApiKey` now validate the key configId is matching the one in the body
...
- [#9187](https://github.com/better-auth/better-auth/pull/9187) [`3728518`](https://github.com/better-auth/better-auth/commit/3728518d1cbd0af1999fd00a6259c4b3f492825f) Thanks [@ping-maxwell](https://github.com/ping-maxwell)! - fix(api-key): run secondary-storage api-key executions in parallel
